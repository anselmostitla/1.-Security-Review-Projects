...
--> This is another vulnerability found in a smart contract
    ...
    function getActivePlayerIndex(address player) external view returns (uint256) {
        ...
        // @audit if the player is at index 0, it'll return 0 and a player might think they are not active, also it returns 0 when the player is really not active. So this is misleading, making think the first player that since he is a zero position it will return zero index making think him that his no active
        return 0;
    }
